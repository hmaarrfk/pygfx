...
class TextGeometry(Geometry):
    ...
    def _shape_text(self, text, font_filename):
        ...
        Can be overloaded for custom behavior.
        """
        return textmodule.shape_text(
            text, font_filename, self._direction, self.ref_glyph_size
        )
    ...
    def _generate_glyph(self, glyph_indices, font_filename):
        ...
        Can be overloaded for custom behavior.
        """
        return textmodule.generate_glyph(
            glyph_indices, font_filename, ref_glyph_size=self.ref_glyph_size
        )
